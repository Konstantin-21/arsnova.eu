...
**Status:** Historischer Detailaudit; aktueller zusammengeführter Stand siehe [FINAL-DESIGN-DOD-AUDIT.md](FINAL-DESIGN-DOD-AUDIT.md) und [BACKLOG-DESIGN-COMPLIANCE.md](BACKLOG-DESIGN-COMPLIANCE.md).
