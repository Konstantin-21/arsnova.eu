...
| [QA-Word-Cloud-Stopwoerter-Eingeblendet.png](./QA-Word-Cloud-Stopwoerter-Eingeblendet.png)                       | Vergleich       | Q&A-Wortwolke mit eingeblendeten Stopwörtern           | Eignet sich als Kontrastbild, um zu zeigen, welche Fragewörter und Funktionswörter ohne Filter wieder Dominanz gewinnen; kein aktueller UI-Toggle.       |
...
| [Quiz-Freitext-Word-Cloud-Stopwoerter-Eingeblendet.png](./Quiz-Freitext-Word-Cloud-Stopwoerter-Eingeblendet.png) | Vergleich       | Quiz-Freitext-Wortwolke mit eingeblendeten Stopwörtern | Eignet sich als Kontrastbild, um den Unterschied zwischen verdichteter Sicht und sprachlichem Rauschen nachvollziehbar zu machen; kein aktueller Toggle. |
